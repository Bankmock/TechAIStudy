...
function checkedopn() {
    ...
    const currentButton = buttons[qcurrentQuestionsp];
  ...
  qcurrentQuestionsp = 0;
          qcurrentQuestionsp = qcurrentQuestionsp + r;
...
function clearresponsek() {
    ...
    if (qcurrentQuestionsp >= 0 && qcurrentQuestionsp < buttons.length) {
        buttons[qcurrentQuestionsp].style = 'background-position: 0px -136px; color: rgb(255, 255, 255);';
    }
}
...
function marknextPrev() {
    if (qcurrentQuestionsp >= 0 && qcurrentQuestionsp < buttons.length) {
        buttons[qcurrentQuestionsp].style = 'background-position: 0px -180px; color: rgb(255, 255, 255);';
        marked++;
    }
